...
| アーキテクチャ | 実装 | 備考 |
|--------------|------|------|
| **x64 (LLVM MC)** | `lea r10, [rip + _data_base]`<br>`mov rax, [r10 + 8]`<br>`mov [rsp + 0], rax` | RIP相対アドレッシング必須 |
...
| アーキテクチャ | 実装 | 備考 |
|--------------|------|------|
| **x64 (LLVM MC)** | `lea r10, [rip + _rodata_base]`<br>`mov rax, [r10 + 8]`<br>`mov [rsp + 0], rax` | RIP相対アドレッシング必須 |
